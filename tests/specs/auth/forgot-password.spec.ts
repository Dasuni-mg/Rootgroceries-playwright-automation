...
test.describe('Forgot Password', () => {
  ...
  test('should display forgot password page with heading', async ({ forgotPasswordPage }) => {
    await forgotPasswordPage.open();
    await expect(forgotPasswordPage.heading).toBeVisible();
  });

  test('should display email input and reset button', async ({ forgotPasswordPage }) => {
    await forgotPasswordPage.open();
    await expect(forgotPasswordPage.emailInput).toBeVisible();
    await expect(forgotPasswordPage.resetButton).toBeVisible();
  });

  test('should allow entering email', async ({ forgotPasswordPage }) => {
    await forgotPasswordPage.open();
